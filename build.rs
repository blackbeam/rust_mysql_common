...
fn gen_bindings(mysql_src: &Path, out_dir: &Path) {
    let builder = builder()
        ...
        .whitelist_type("decimal_t")
        .whitelist_function("c_string2decimal")
        .whitelist_function("c_decimal2string")
        .whitelist_function("c_decimal2bin")
        .whitelist_function("c_bin2decimal")
        .whitelist_function("c_decimal_bin_size")
        .derive_debug(false)
        .use_core()
