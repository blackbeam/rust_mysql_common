...
#[repr(transparent)]
pub struct UpdateRowsEvent<'a>(RowsEvent<'a>);

impl<'a> UpdateRowsEvent<'a> {
    ...
    pub fn into_owned(self) -> UpdateRowsEvent<'static> {
        UpdateRowsEvent(self.0.into_owned())
    }
}
...
impl<'a> BinlogStruct<'a> for UpdateRowsEvent<'a> {
